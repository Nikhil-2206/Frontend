...
const moodToQuery = {
  ...
  lofi: {
    ...
    music: [
      "arijit singh lofi",
      "arijit singh lofi remix",
      "arijit singh lofi mashup",
      "arijit singh lofi mix",
      "arijit singh lofi love songs",
      "arijit singh lofi romantic",
      "arijit singh lofi hits",
      "arijit singh lofi playlist",
      "arijit singh lofi sad songs",
      "arijit singh lofi emotional",
      "hindi lofi love songs",
      "bollywood lofi remix",
      "hindi romantic lofi",
      "bollywood lofi mix",
      "hindi lofi mashup",
      "bollywood lofi love songs",
      "hindi lofi romantic songs",
      "bollywood lofi trending",
      "hindi lofi hits",
...
async function fetchJioSaavnMusicRandom(mood) {
  ...
  // For lofi mood, try to fetch multiple songs from different queries
  if (mood === 'lofi') {
    let allTracks = [];
    for (let q of queries) {
      try {
        ...
        if (data.success && data.data.results.length) {
          allTracks = [...allTracks, ...data.data.results];
        }
      } catch {}
    }
    ...
    if (allTracks.length > 0) {
      ...
      // Take first 20 tracks or all if less than 20
      currentTracks = allTracks.slice(0, 20);
      currentTrackIndex = 0;
